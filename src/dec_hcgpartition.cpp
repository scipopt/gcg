...
extern "C"
SCIP_RETCODE SCIPincludeDetectionHcgpartition(
   ...
   )
{
   ...
   SCIP_CALL( DECincludeDetector(scip, DEC_DETECTORNAME, DEC_DECCHAR, DEC_DESC, DEC_PRIORITY, DEC_ENABLED, DEC_SKIP, detectordata, detectAndBuildArrowhead, initHcgpartition, exitHcgpartition, propagateSeeedHcgpartition) );
