...
/**@file   reader_bipartite.h
 * @brief  BIPARTITE file reader
 * @author Martin Bergner
 * @author Lukas Kirchhart
 * @ingroup FILEREADERS

 * This reader reads in a bipartite-file that defines the structur to be used for the bipartiteomposition.
...
#ifndef __SCIP_READER_BIPARTITE_H__
#define __SCIP_READER_BIPARTITE_H__
...
/** includes the bipartite file reader into SCIP */
extern
SCIP_RETCODE SCIPincludeReaderBipartite(
