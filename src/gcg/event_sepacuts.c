...
SCIP_DECL_EVENTEXEC(eventExecRowAdded)
{
   ...
   sepaidx = SCIPhashmapGetImageInt(eventhdlrdata->sepaxidx, sepa);
   //assert(sepaidx!= INT_MAX);
   SCIPdebugMessage("cut was generated by sepa (%s, %i)\n", SCIPsepaGetName(sepa), sepaidx);
