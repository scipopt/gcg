...
#define DEC_NAME                  "hrcgpartition"    /**< name of the detector */
...
)
{
   ...
   *result = SCIP_DIDNOTFIND;
   ...
   SCIP_CALL( SCIPgetIntParam(scip, "detection/detectors/hrcgpartition/maxnblockcandidates", &maxnblockcandidates) );
   ...
   graph = new HyperrowcolGraph<gcg::GraphTclique>(gcg, w);
...
GCG_DECL_FINISHPARTIALDEC(finishPartialdecHrcgpartition)
{
   ...
   detection(gcg, GCGdetectorGetData(detector), partialdecdetectiondata, partialdec, false, result);
