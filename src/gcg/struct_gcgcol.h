...
struct GCG_Col
{
   ...
   SCIP_Real*           genericmastercutcoefs;/**< array of generic mastercut coefficient values */
   SCIP_Real*           genericmastercutbounds;/**< array of generic mastercut bounds */
   int                  ngenericmastercuts; /**< number of generic mastercuts */
