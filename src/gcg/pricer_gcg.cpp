   ...
   )
{
   ...
   activecuts = GCGeventmastersepacutGetActiveMastersepacuts(gcg, pricerdata->mastersepacuthdlr);
   nactivecuts = GCGeventmastersepacutGetNActiveMastersepacuts(gcg, pricerdata->mastersepacuthdlr);
