...
/** method for getting the mastercutdata for a given row
 *
 *  input:
 ...
 */
#define GCG_DECL_SEPAGETMASTERCUTDATA(x) SCIP_RETCODE x (SCIP* scip, GCG_SEPA* sepa, SCIP_ROW* row, GCG_MASTERCUTDATA** result)
