...
{  /*lint --e{715}*/
   ...
   SCIP_CALL( GCGrelaxIncludeBranchrule(scip, branchrule, branchActiveMasterOrig,
         ...
         branchNewColXyz, branchUpdateDualXyz, branchGetMastercutXyz) );
...
/** called when the dual value of the mastercut has been determined */
#ifdef SCIP_DISABLED_CODE
static
GCG_DECL_BRANCHUPDATEDUAL(branchUpdateDualXyz)
{  /*lint --e{715}*/
   SCIPerrorMessage("method of xyz branching rule not implemented yet\n");
   SCIPABORT(); /*lint --e{527}*/
...
#else
#define branchUpdateDualXyz NULL
#endif

/** call to get a possible mastercut generated by this branching rule */
#ifdef SCIP_DISABLED_CODE
static
GCG_DECL_BRANCHGETMASTERCUT(branchGetMastercutXyz)
{  /*lint --e{715}*/
   SCIPerrorMessage("method of xyz branching rule not implemented yet\n");
   SCIPABORT(); /*lint --e{527}*/
...
#else
#define branchGetMastercutXyz NULL
#endif
