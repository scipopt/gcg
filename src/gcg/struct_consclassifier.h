...
struct GCG_ConsClassifier {
   ...
   GCG_DECL_FREECONSCLASSIFIER((*freeClassifier));                  /**< destructor of detector */
   GCG_DECL_CONSCLASSIFY((*classify));            /**< structure detection method of detector */
};
