...
/**@file   score_spfawh.h
 * @ingroup SCORES
 * @brief  setpartitioning maximum foreseeing white area score with aggregation information score
 * @author Jurgen Lentz
 */

/*---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8----+----9----+----0----+----1----+----2*/

#ifndef __GCG_SCORE_SPFAWH_H__
#define __GCG_SCORE_SPFAWH_H__
