   ...
   )
{
   ...
   SCIPdebugMessage("Free sepamastercutcoeffs for gcgcol %p with nsepas %i\n", (*gcgcol), (*gcgcol)->nsepas);
   if( (*gcgcol)->nsepas > 0 )
   {
   ...
   SCIPdebugMessage("Free gcgcol %p\n", (*gcgcol));
   ...
   )
{
   ...
   SCIPdebugMessage("Init sepa mastercut coeffs for gcgcol %p\n", gcgcol);
   return SCIP_OKAY;
}
