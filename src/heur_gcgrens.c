   ...
   )
{
   ...
   *result = SCIP_DIDNOTFIND;
   ...
   if( allfixingrate >= minfixingrate / 2.0 )
   {
      ...
      SCIPstatisticPrintf("GCG RENS statistic: fixed %6.3f integer variables ( %6.3f zero), %6.3f all variables, needed %6.1f sec (SCIP time: %6.1f sec), %"SCIP_LONGINT_FORMAT" nodes, found %d solutions, solution %10.4f found at node %"SCIP_LONGINT_FORMAT"\n",
