...
static
SCIP_RETCODE printStairheurScores(
      SCIP*                 scip,           /**< SCIP data structure */
      DEC_DETECTORDATA*     detectordata,   /**< detectordata data structure */
      DEC_STAIRHEURSCORES* scores          /**< score data structure */
      )
{
...
static SCIP_RETCODE buildTransformedProblem(
   SCIP*                    scip,           /**< SCIP data structure */
   DEC_DETECTORDATA*      detectordata,  /**< presolver data data structure */
   DEC_STAIRHEURSCORES*    score           /**< scores */
   )
{
...
SCIP_RETCODE evaluateDecomposition(
      SCIP*                 scip,           /**< SCIP data structure */
      DEC_DETECTORDATA*   detectordata,  /**< presolver data data structure */
      DEC_STAIRHEURSCORES* score           /**< returns the score of the decomposition */
      )
{
   char name[SCIP_MAXSTRLEN];
...
//     SCIP_CALL(writeDWsolverOutput(scip, detectordata));
     ...
     SCIP_CALL(printStairheurScores(scip, detectordata, &score));
