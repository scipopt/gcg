...
/**@file   dec_colors.h
 * @brief  colors compontent detector
 ...
 * - The pricing problems correspond to colors components in the remaining graph
 */

/*---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8----+----9----+----0----+----1----+----2*/

#ifndef GCG_DEC_COLORS_H__
#define GCG_DEC_COLORS_H__
