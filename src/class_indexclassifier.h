...
#ifndef GCG_CLASS_INDEXCLASSIFIER_H__
#define GCG_CLASS_INDEXCLASSIFIER_H__
...
protected:
   ...
   /** copy constructor */
   IndexClassifier(
      const IndexClassifier* toCopy              /**< IndexClassifier to be copied */
   );
...
#endif /* SRC_CLASS_INDEXCLASSIFIER_H_ */
