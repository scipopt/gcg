 ...
 * @ingroup DETECTORS
 * @brief  detector generalmastersetcover (put your description here)
...
static
DEC_DECL_FREEDETECTOR(freeGeneralmastersetcover)
{
...
)
{
   ...
   SCIP_CALL(
      DECincludeDetector(scip, DEC_DETECTORNAME, DEC_DECCHAR, DEC_DESC, DEC_PRIORITY, DEC_ENABLED, DEC_SKIP, detectordata, detectGeneralmastersetcover, freeGeneralmastersetcover, initGeneralmastersetcover, exitGeneralmastersetcover, propagateSeeedGeneralmastersetcover));
