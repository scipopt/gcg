...
#define setParamAggressiveGeneralmastersetcover NULL
#define setParamDefaultGeneralmastersetcover NULL
#define setParamFastGeneralmastersetcover NULL
