...
#define DEFAULT_MAXROUNDS             3 /**< maximal number of cmirgcg separation rounds per node (-1: unlimited) */
#define DEFAULT_MAXROUNDSROOT        10 /**< maximal number of cmirgcg separation rounds in the root node (-1: unlimited) */
...
#define DEFAULT_MAXSEPACUTS         100 /**< maximal number of cmirgcg cuts separated per separation round */
#define DEFAULT_MAXSEPACUTSROOT     500 /**< maximal number of cmirgcg cuts separated per separation round in root node */
...
struct SCIP_SepaData
{
   ...
   int                   maxrounds;          /**< maximal number of cmirgcg separation rounds per node (-1: unlimited) */
   int                   maxroundsroot;      /**< maximal number of cmirgcg separation rounds in the root node (-1: unlimited) */
   ...
   int                   maxsepacuts;        /**< maximal number of cmirgcg cuts separated per separation round */
   int                   maxsepacutsroot;    /**< maximal number of cmirgcg cuts separated per separation round in root node */
 ...
 */
SCIP_RETCODE SCIPcutGenerationHeuristicCmirgcg(
   SCIP*                 scip,               /**< SCIP data structure */ 
   SCIP_SOL*             sol,                /**< the solution that should be separated, or NULL for LP solution */
   SCIP_Real*            varsolvals,         /**< LP solution value of all variables in LP */
   int                   maxtestdelta,       /**< maximal number of different deltas to try (-1: unlimited) */
   ...
   *wastried = FALSE;
   ...
   while( nactiveconts <= maxconts && naggrs <= maxaggrs && naggrcontnonzs + naggrintnonzs <= maxaggrnonzs )
   {
      ...
      *wastried = TRUE;
       ...
       */
      oldncuts = *ncuts;
      SCIP_CALL( SCIPcutGenerationHeuristicCmirgcg(scip, sol, varsolvals, 
            sepadata->maxtestdelta, rowweights, BOUNDSWITCH, USEVBDS, ALLOWLOCAL, sepadata->fixintegralrhs, sepadata->maxrowfac,
            MINFRAC, MAXFRAC, sepadata->trynegscaling, sepadata->dynamiccuts, "cmirgcg", ncuts) );
      ...
      for( nzi = 0; nzi < naggrcontnonzs; ++nzi )
      {
         ...
         if( bounddist >= bestbounddist - sepadata->aggrtol )
         {
            ...
            for( r = 0; r < nnonzrows; r++ )
            {
               ...
               aggrfac = 1.0/(naggrs+2)*(naggrs % 2 == 0 ? -1.0 : 1.0);
            }
   ...
   )
{
   ...
   *result = SCIP_DIDNOTRUN;
   ...
   /* only call the cmirgcg cut separator a given number of times at each node */
...
static
SCIP_DECL_SEPAFREE(sepaFreeCmirgcg)
{  /*lint --e{715}*/
   SCIP_SEPADATA* sepadata;
...
#define sepaInitCmirgcg NULL


/** deinitialization method of separator (called when problem solving exits) */
#define sepaExitCmirgcg NULL


/** solving process initialization method of separator (called when branch and bound process is about to begin) */
#define sepaInitsolCmirgcg NULL


/** solving process deinitialization method of separator (called before branch and bound process data is freed) */
#define sepaExitsolCmirgcg NULL


/** LP solution separation method of separator */
static
SCIP_DECL_SEPAEXECLP(sepaExeclpCmirgcg)
{  /*lint --e{715}*/
...
static
SCIP_DECL_SEPAEXECSOL(sepaExecsolCmirgcg)
{  /*lint --e{715}*/
...
/** creates the cmirgcg separator and includes it in SCIP */
SCIP_RETCODE SCIPincludeSepaCmirgcg(
   SCIP*                 scip                /**< SCIP data structure */
   )
{
   SCIP_SEPADATA* sepadata;

   /* create cmirgcg separator data */
   SCIP_CALL( SCIPallocMemory(scip, &sepadata) );

   /* include separator */
   SCIP_CALL( SCIPincludeSepa(scip, SEPA_NAME, SEPA_DESC, SEPA_PRIORITY, SEPA_FREQ, SEPA_MAXBOUNDDIST, SEPA_DELAY,
         sepaFreeCmirgcg, sepaInitCmirgcg, sepaExitCmirgcg, 
         sepaInitsolCmirgcg, sepaExitsolCmirgcg, 
         sepaExeclpCmirgcg, sepaExecsolCmirgcg,
         sepadata) );

   /* add cmirgcg separator parameters */
   SCIP_CALL( SCIPaddIntParam(scip,
         "separating/cmirgcg/maxrounds",
         "maximal number of cmirgcg separation rounds per node (-1: unlimited)",
         &sepadata->maxrounds, FALSE, DEFAULT_MAXROUNDS, -1, INT_MAX, NULL, NULL) );
   SCIP_CALL( SCIPaddIntParam(scip,
         "separating/cmirgcg/maxroundsroot",
         "maximal number of cmirgcg separation rounds in the root node (-1: unlimited)",
         &sepadata->maxroundsroot, FALSE, DEFAULT_MAXROUNDSROOT, -1, INT_MAX, NULL, NULL) );
   SCIP_CALL( SCIPaddIntParam(scip,
         "separating/cmirgcg/maxtries",
   ...
   SCIP_CALL( SCIPaddIntParam(scip,
         "separating/cmirgcg/maxtriesroot",
   ...
   SCIP_CALL( SCIPaddIntParam(scip,
         "separating/cmirgcg/maxfailsroot",
   ...
   SCIP_CALL( SCIPaddIntParam(scip,
         "separating/cmirgcg/maxaggrsroot",
   ...
   SCIP_CALL( SCIPaddIntParam(scip,
         "separating/cmirgcg/maxcontsroot",
