...
#define detectMastersetcover NULL
...
#define detectorPostprocessSeeedMastersetcover NULL
...
)
{
   ...
   SCIP_CALL(
      DECincludeDetector(scip, DEC_DETECTORNAME, DEC_DECCHAR, DEC_DESC, DEC_FREQCALLROUND,
         ...
         initMastersetcover, exitMastersetcover, propagateSeeedMastersetcover, NULL, finishSeeedMastersetcover, detectorPostprocessSeeedMastersetcover, setParamAggressiveMastersetcover, setParamDefaultMastersetcover, setParamFastMastersetcover));
