...
class StatisticReader:
   ...
   def checkSolverType(self, line):
      ...
      if "Gurobi Optimizer version" in line and self.solvertype != StatisticReader.SOLVERTYPE_GUROBI:
         ...
         changed = True
      elif "SCIP version " in line and self.solvertype != StatisticReader.SOLVERTYPE_SCIP and self.solvertype != StatisticReader.SOLVERTYPE_GCG:
         ...
         changed = True
      elif "GCG version " in line and self.solvertype != StatisticReader.SOLVERTYPE_GCG:
         StatisticReader.solvertype = StatisticReader.SOLVERTYPE_GCG
         changed = True
      if changed:
