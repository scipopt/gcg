...
do
    ...
    RESFILE=$DIR/$NAME-sepas.res
    TEXFILE=$DIR/$NAME-sepas.tex
    PAVFILE=$DIR/$NAME-sepas.pav
    ...
    awk -f check_sepas.awk -v "TEXFILE=$TEXFILE" -v "PAVFILE=$PAVFILE" $AWKARGS $TESTFILE $SOLUFILE $OUTFILE | tee $RESFILE
done
